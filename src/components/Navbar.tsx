const Navbar = ({ handleClickOnNavbarButtons }) => {
  const handleClick = (page) => {
    handleClickOnNavbarButtons(page);
  };

  return (
    <div>
      <div className="xl:pb-5 sm:pb-5" />
      <div className="flex xl:justify-center sm:justify-center xs:justify-center">
        <div className=" bg-white xl:p-5  sm:p-5 xs:p-0 xl:rounded-xl sm:rounded-xl  xl:w-[1800px] sm:w-[760px] xs:w-[410px] xs:h-20 xl:pl-10 sm:pl-10 xs:pl-0 flex justify-between items-center">
          <svg
          ...
          <div className="flex items-center">
            <button
              ...
              className="bg-white flex justify-center xl:w-28 sm:w-28 xs:w-28 xs:h-12 hover:border-white hover:text-purp xl:text-gray-500 sm:text-gray-500 xs:text-gray-500  focus:bg-light-purp  focus:text-purp"
            >
              <svg
            ...
            <button
              ...
              className="bg-white flex justify-center xl:w-44 sm:w-44 xs:w-28 xl:h-12 xs:h-11 hover:border-white hover:text-purp text-gray-500 focus:bg-light-purp focus:text-purp"
            >
              <svg
                width="21"
                height="20"
          ...
          <a href="/preview">
            <button className="border-purp xs:bg-headerPreview xl:bg-none sm:bg-none xs:bg-no-repeat xs:bg-center xl:text-purp sm:text-purp xs:text-transparent bg-white outline-purp   hover:bg-light-purp xl:w-[150px] sm:w-[150px] xs:w-[60px] mr-3">
              Preview
            </button>
          </a>
        </div>
